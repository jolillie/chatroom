...
def start():
    ...
    if request.method == "POST":
        ...
        if create != False:
            ...
            return render_template("start.html", error="Room does not exist.", code=code, name=name)
...
if __name__ == "__main__":
    socketio.run(app, host="0.0.0.0", port=os.environ.get("FLASK_SERVER_PORT", 9090), debug=True)